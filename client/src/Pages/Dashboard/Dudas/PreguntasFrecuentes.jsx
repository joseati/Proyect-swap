...
export const PreguntasFrecuentes = () => {
  return (
    <Col>
      <Row>
        <Col>
        <h2 className='h2-head'>Preguntas Frecuentes</h2>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <Col>
          <Accordion defaultActiveKey="0" className='cont-accord'>
          <Accordion.Item eventKey="1">
            <Accordion.Header>
              <span className='head-accord'>¿PUEDO CEDER/VENDER MI VIAJE A OTRA PERSONA?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header>
              <span className='head-accord'>¿QUÉ VIAJES SE PUEDEN TRANSFERIR?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="3">
            <Accordion.Header>
              <span className='head-accord'>¿QUIÉN CAMBIA EL NOMBRE DEL BILLETE QUE HE COMPRADO?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="4">
            <Accordion.Header>
              <span className='head-accord'>¿QUÉ ME ACONSEJÁIS PARA ASEGURARME VENDER MI VIAJE?</span>
              </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="5">
            <Accordion.Header>
              <span className='head-accord'>¿CUÁNTO CUESTA EL CAMBIO DE TITULARIDAD CON MI COMPAÑÍA AÉREA?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="6">
            <Accordion.Header>
              <span className='head-accord'>¿TIENE ALGÚN COSTE PONER EN VENTA MI BILLETE/BONO/PAQUETE VACACIONAL, ETC?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="7">
            <Accordion.Header>
              <span className='head-accord'>SI UN COMPRADOR EXTERNO A SWAP YOUR TRAVEL SE INTERESA POR MI PRODUCTO, ¿PUEDO VENDER MI PRODUCTO?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="8">
            <Accordion.Header>
              <span className='head-accord'>¿ES NECESARIO PROPORCIONAR EL CÓDIGO DE MI BONO?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="9">
            <Accordion.Header>
              <span className='head-accord'>¿POR QUÉ TENGO QUE COMPARTIR INFORMACIÓN PERSONAL CON SWAP YOUR TRAVEL?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="10">
            <Accordion.Header>
              <span className='head-accord'>¿QUÉ PASA SI NO COMPARTO ESTA INFORMACIÓN?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="11">
            <Accordion.Header>
              <span className='head-accord'>¿CÓMO GUARDA SWAP YOUR TRAVEL MIS DATOS?</span>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="12">
            <Accordion.Header>
              <span className='head-accord'>¿QUÉ HACE SWAP YOUR TRAVEL CON MIS DATOS?</span>
            </Accordion.Header>
            <Accordion.Body>
