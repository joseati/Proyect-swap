    ...
    <Row>
      <Col>
        ...
        <table className="table table-bordered">
          <thead>
            <tr>
              <th colspan="2 " className="text-center py-3 text-primary">
        ...
        <table class="table table-bordered ">
          <thead>
            <tr>
              <th colspan="2 " class="text-center py-3 text-primary">
                INFORMACIÓN BÁSICA SOBRE PROTECCIÓN DE DATOS
              </th>
            </tr>
          </thead>
        ...
        <p>
          ...
          Derechos Digitales y el Reglamento Europeo de Protección de Datos, se
          le informa sobre la incorporación de sus datos a un fichero
          titularidad de ANA GONZÁLEZ VEGA, con domicilio en CL. CARDENAL
          ILUNDAIN, 24 41013 SEVILLA. La finalidad del tratamiento es la gestión
          de datos de clientes y proveedores y su legitimación es la ejecución
          de contratos. Las cesiones que podrán llevarse a cabo, serán aquellas
          necesarias para el desarrollo de la relación jurídica existente entre
          las partes, así como aquellas que se encuentren previstas en la Ley,
          tales como aquellas cuyos destinatarios son entidades financieras, la
          Agencia Tributaria o Juzgados y Tribunales.
          <br />
          <br />
