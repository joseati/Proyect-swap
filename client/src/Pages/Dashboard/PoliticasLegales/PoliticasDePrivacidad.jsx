      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={8} className="mx-auto">
            <p>
              A efectos de lo dispuesto en el Reglamento Europeo de Protección
              de Datos, ANA GONZÁLEZ VEGA, le informa que en determinadas áreas
              de nuestra Web se solicita al usuario una serie de datos de
              carácter personal. El usuario siempre tiene la opción de aceptar o
              rechazar las condiciones legales bajo las cuales facilitará esos
              datos. Se considera esa aceptación como consentimiento informado,
              y autoriza expresamente el tratamiento con las siguientes
              características:
            </p>
            <Table bordered>
              <thead>
                <tr>
                  <th colSpan="2" style={{fontFamily:"Numito", fontSize:"16x", color:"#005a8d"}} className="text-center text-primary">
              ...
              <tbody>
                ...
                <tr>
                  <td>Finalidad</td>
                  <td>
                    Atender su solicitud de información u otro tipo de
                    peticiones que haya realizado por medio de nuestra página
                    web.
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Derechos</td>
                  <td>
                    Acceso, rectificación, supresión y oposición al tratamiento
                    de datos.
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    Protección de Datos en la dirección de correo electrónico
                    que figura en nuestros datos de contacto.
                  </td>
                </tr>
              </tbody>
            </Table>
            <p>
              ...
              registrados son de la mayor importancia y por ello se compromete
              al cumplimiento de su obligación de secreto de los datos de
              carácter personal y de su deber de tratarlos con confidencialidad,
              por lo que ha elaborado un Registro de Actividades de Tratamiento
              que recoge las medidas destinadas a proteger la confidencialidad
              de los datos de carácter personal que obran en su poder, de
              acuerdo con el Reglamento Europeo de Protección de Datos.
            </p>
            <Table bordered>
              <thead>
                <tr>
                  <th style={{fontFamily:"Numito", fontSize:"16x", color:"#005a8d"}}  colSpan="2" className="text-center text-primary">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    También puede contactar con nosotros por medio de la
                    siguiente dirección de correo electrónico:
                    info@swapyourtravel.com
                  </td>
                </tr>
                <tr>
            ...
            <Table bordered>
              <tbody>
                <tr>
                  ...
                  <td>
                    Los datos se conservarán durante los periodos en que se
                    pueda derivar una responsabilidad para nuestra firma, de
                ...
                <tr>
                  ...
                  <td>
                    ...
                    ejecución la tramitación de las solicitudes de información
                    que haya podido realizar por medio de nuestra página web.
                  </td>
                </tr>
                <tr>
                  <td>¿A qué destinatarios se comunicarán sus datos?</td>
                  <td>
                    Los datos que nos facilite no serán objeto de cesión,
                    excepto en aquellos supuestos que así lo exija la Ley.
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    les conciernan o no.
                    <br />
                    Las personas interesadas tienen derecho a acceder a sus
                    datos personales, así como a solicitar la rectificación de
                    los datos inexactos o, en su caso, solicitar su supresión
                    cuando, entre otros motivos, los datos ya no sean necesarios
                    para los fines que fueron recogidos.
                    <br />
                    Los interesados podrán solicitar la limitación del
                    tratamiento de sus datos, en cuyo caso únicamente los
                    conservaremos para el ejercicio o la defensa de
                    reclamaciones.
                    <br />
                    En determinadas circunstancias y por motivos relacionados
                    con su situación particular, los interesados podrán oponerse
                    al tratamiento de sus datos. ANA GONZÁLEZ VEGA
                    <br />
