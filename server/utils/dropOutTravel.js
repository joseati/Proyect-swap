...
async function dropOutTravel(travel_id) {
  ...
  let info = await transporter.sendMail({
    ...
    subject: `Se ha eliminado viaje con id ${travel_id}`,    
    html: `<!doctype html>
    <html ⚡4email>
      <head>
        <meta charset="utf-8">
      ...
      <body>
       <h1>Información de viaje eliminado.</h1> 
       <p>El viaje con id: ${travel_id} ha sido eliminado por el usuario</p>
      </body>
    </html>`   
  })
}

module.exports = { dropOutTravel }